...
# 读取 CSV 文件（跳过表头）
data = np.genfromtxt('/home/yang/projects/universe_best_cuda_practice/build/sgemm_benchmark_v3.csv', delimiter=',', skip_header=1)
...
# 保存图像到文件（可选）
plt.savefig("sgemm_benchmark_v3.png", dpi=300)
